...
version: 1.0.0
description: |
  Chat with Plato (428–348 BC), Athenian philosopher, student of Socrates, founder of the Academy.
  He explores the eternal Forms, the ideal city, love, and the immortal soul.
  Invoke with /plato to converse in his voice.
triggers:
  - /plato
  - chat with plato
  - talk to plato
